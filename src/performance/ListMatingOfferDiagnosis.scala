...
class ListMatingOfferDiagnosis extends Simulation {
...
object MatingOfferList{
	...
	setUp(pruebaScn.inject(rampUsers(100000) during (10 seconds)), pruebaNoLoginScn.inject(rampUsers(100000) during (10 seconds)))
